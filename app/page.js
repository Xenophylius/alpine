  ...
  return (
    ...
    <section className="container-fluid m-0 p-0 ">
      <Splide aria-label="My Favorite Images" className="z-0">
        ...
        <SplideSlide className="position-relative">
          <img style={{height : 100 + 'vh !important;',  width : 100 + '%'}} src="https://cdn.group.renault.com/alp/master/alpine-new-cars/homepage/banners/desktop/alpine-A110s-hp-desktop.jpg.ximg.largex2.webp/87fab305ac.webp" alt="Image 2"/>
          <div className="position-absolute top-50 start-0 translate-middle-y mx-5 px-5 text-light bw-bold ">
            <h3>A110 S</h3>
    ...
    <section className="bgBlack m-0 p-0 py-3">
