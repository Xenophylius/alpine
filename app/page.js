...
export default function Home() {
  return (
    ...
    <section className="bgBlack m-0 p-0 border-top border-3">
      <h2 className="text-center text-light mt-4">LIFESTYLE</h2>
      <div className="row justify-content-center my-5 px-5 mx-5">
        <div className="col-12 col-xl-4 py-4 py-xl-0 position-relative ">
          <img className='imgSoc text-center imgGray' src="https://cdn.group.renault.com/alp/master/alpine-new-cars/homepage/editorial/homepage-2024/alpine-homepage-007.jpg.ximg.largex2.webp/7f6a3aeab9.webp" />
          <div className="position-absolute top-0 mt-5 ms-5 text-light"><h4>ALPINE X PADEL</h4><p>La rencontre de l’agilité et de la performance</p></div>
        ...
        <div className="col-12 col-xl-4 py-4 py-xl-0 row justify-content-center px-0">
            <div className="col-12 pb-4 py-xl-0 position-relative ">
              <img className="imgSocMiddle text-center imgGray" src="https://cdn.group.renault.com/alp/master/alpine-new-cars/homepage/editorial/homepage-2024/alpine-homepage-008.jpg.ximg.largex2.webp/905cc8ba64.webp" />
              <p className="btn btn-outline-light position-absolute bottom-0 end-0 mb-4 me-5 rounded-0 ">DECOUVRIR</p>
              <div className="position-absolute top-0 mt-5 ms-5 text-light"><h4>COLLECTIONS ALPINE</h4><p>Un style empreint de légèreté et de technicité</p></div>
            </div>
        ...
        <div className="col-12 col-xl-4 py-4 py-xl-0 position-relative ">
          <img className='imgSoc text-center imgGray' src="https://cdn.group.renault.com/alp/master/alpine-new-cars/homepage/editorial/homepage-2024/alpine-homepage-010.jpg.ximg.largex2.webp/8ae1756532.webp" />
          <p className="btn btn-outline-light position-absolute bottom-0 end-0 mb-4 me-5 rounded-0 ">DECOUVRIR</p>
          <div className="position-absolute top-0 mt-5 ms-5 text-light"><h4>COLLABORATIONS ALPINE</h4><p>Projets et rencontres célébrant notre anticonformisme</p></div>
        </div> 
      </div>
    </section>
